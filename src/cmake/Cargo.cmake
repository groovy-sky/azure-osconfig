function(cargo_build)
    ...
    # set(LIB_HEADER ${CMAKE_CURRENT_SOURCE_DIR}/inc/${LIB_NAME}.h)

    # add_custom_command(
    #     OUTPUT ${LIB_HEADER}
    #     COMMAND cbindgen ARGS --config cbindgen.toml --crate ${LIB_NAME} --output inc/${LIB_NAME}.h
    #     WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    #     COMMENT "Generating header with cbindgen"
    # )
    ...
    add_custom_command(
        ...
        WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
        # DEPENDS ${LIB_SOURCES} ${LIB_HEADER}
        DEPENDS ${LIB_SOURCES}
    ...
    # set_target_properties(${CARGO_NAME} PROPERTIES IMPORTED_LOCATION ${LIB_FILE} INTERFACE_INCLUDE_DIRECTORIES ${CMAKE_CURRENT_SOURCE_DIR}/inc)
endfunction()