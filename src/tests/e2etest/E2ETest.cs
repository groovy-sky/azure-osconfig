...
namespace E2eTesting
{
    ...
    public abstract class E2ETest
    {
        ...
        public void OneTimeSetUp()
        {
            ...
            if (null != Environment.GetEnvironmentVariable("TWIN_TIMEOUT"))
            {
                _maxWaitTimeSeconds = int.TryParse(Environment.GetEnvironmentVariable("TWIN_TIMEOUT"), out _maxWaitTimeSeconds) ? _maxWaitTimeSeconds : DEFAULT_MAX_WAIT_SECONDS;
